		...
		<div class="col-12 mx-auto">
			<div class="card card-info">
				<div class="card-header">
					<h3 class="card-title">Funcionalidades / Personalizações</h3>
				</div>
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-4" id="botoes_parametros_personalizacoes">
							<div class="btn-group">
								...
								<div class="dropdown-menu">
									<div class="px-4 py-3" style="width: 315px">
										<div class="row">
											<div class="col-12">
												<label class="form-group has-float-label">
									...
									<div class="px-4 py-3" style="width: 315px">
										<div class="row">
											...
											<div class="col-12">
												...
												<div class="custom-control custom-checkbox">
													<input type="checkbox" class="custom-control-input" id="mostrar_detalhes"
														name="mostrar_detalhes" value="true" checked onchange="orcamentoManutencao.toggleColunasTabela()" />
													<label class="custom-control-label" for="mostrar_detalhes">Mostrar Detalhes</label>
												</div>
											</div>
										</div>
									</div>
								...
								<div id="campos_componentes" class="campo_multiplo" data-aceita-valores-duplicados='true'>
									<table class="conteiner">
										<thead>
											<tr>
												<th>
													<div class="row">
														<div class="col-9">Componentes</div>
														<div class="col-3">
															<label class="form-group has-float-label" style="margin-bottom: 0">
																<select id="template_funcionalidade" name="template_funcionalidade" class="select form-control"
																	onchange="orcamentoManutencao.confirmarCarregamentoComponentesInclusaoFuncionalidadeByTipo(this)">
																	<option value="">Escolha um template</option>
																	<?php foreach($tipoFuncionalidade_rs as $tipoFuncionalidade_row){ ?>
																		<option value="<?php echo $tipoFuncionalidade_row['id'] ?>"><?php echo $tipoFuncionalidade_row['descricao'] ?></option>
																	<?php } ?>
																</select>
																<span>Template de Funcionalidade</span>
															</label>
														</div>
													</div>
												</th>
											...
											<tr>
												<th class='border'>
													<div class="row componente_inclusao_funcionalidade_orcamento_manutencao">
														...
														<div class="col-3" style="padding-left: 10px">Detalhes</div>
														<div class="col-1">Valor (PF)</div>
													</div>
												</th>
											</tr>
										</thead>
									...
									<div class="template">
										<div class="row componente_inclusao_funcionalidade_orcamento_manutencao">
											...
											<div class="col-3">
												<textarea data-nome="detalhes" id="componente_{iterador}_detalhes"
													name="componentes[{iterador}][detalhes]" class="form-control"></textarea>
											</div>
											<div class="col-1 valor_pf">---</div>
										</div>
									</div>
