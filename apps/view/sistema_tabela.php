...
if(isset($_GET['montar_tabela']) && $_GET['montar_tabela'] === true) {
	...
	<div class="card">
		<div class="card-header">
			...
			<button type="button" class="btn btn-primary float-right" onclick="jForm('sistema_form.php')">
		...
		<div class="card-body">
			<div <?php echo $atributo_id ?> class="<?php echo $classe_tabela ?>" data-pagina="<?php echo $pagina ?>"
				...
				<div class="acoes">
					<button type="button" title="Editar" data-onclick="jForm('sistema_form.php', 'id={id}')" class="btn-success btn-sm">
						<i class="fa fa-edit"></i>
					</button>
					<button type="button" title="Excluir" data-onclick="apagaRegistro('sistema_crud.php', {id})" class="btn-danger btn-sm">
	...
	$total_geral = $sistema->getTotal();
	$total_consulta = $sistema->getTotalByListagem($busca);
	...
	$sistema_rs = $sistema->getByListagem($busca, $ordenacao, $filtragem, $limit, $offset);
